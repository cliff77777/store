            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    @if (null !== optional(session()->get('user_data')) && !empty(session()->has('user_data')))
                        <input type="hidden" id="auth_confirm" auth="member">
                        <div class="text-light">Hello!!
                            {{ session()->get('user_data')->name }} 歡迎您回來</div>
                        <a class="nav-link text-danger" aria-current="page"
                            href="{{ url('user/auth/sign_out') }}">登出</a>
                    @else
                        <input type="hidden" id="auth_confirm" auth="guest">
                        <div class="text-light">Hello!! Guest!!!</div>
