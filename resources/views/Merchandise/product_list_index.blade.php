...
<div class="container content" style="background:white">
    ...
    <div class="col">
      <div class="card " style="width: 18rem;">
        <img src="{{$value["photo"]}}" class="card-img-top {{($value["status"] =='1' ?  : "img_opacity02")}}"  alt="...">
        <div class="card-body">
        ...
        <div class="card-body">
          <a href="#" type='button' class="card-link btn-primary btn edit_btn" data-id="{{$value['id']}}">修改</a>
          <a href="#" type='button' class="card-link btn btn-danger del_btn" data-id="{{$value['id']}}">刪除</a>
        </div>
      </div>
    </div>
    @endforeach
