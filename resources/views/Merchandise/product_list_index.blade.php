                ...
                <div class="col">
                    <div class="card " style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" type='button' class="card-link btn btn-danger del_btn" data-bs-toggle="modal"
                                data-bs-target="#del_modal" data-id="{{ $value['id'] }}">刪除</a>
                        </div>
                    </div>
                </div>
            @endforeach
